...
contract BRNVestingProxy is  BRNVestingAdminStorage {
    ...
    /**
      * @notice Emitted when pendingImplementation is accepted, which means BRNVesting implementation is updated
      */
    ...
    */
    ...
    constructor(address implementation_,
                address _brnAddress) nonZeroAddress(implementation_) nonZeroAddress(_brnAddress) public {
    ...
    */
    function _setImplementation(address implementation_) public {
        require(msg.sender == admin, "BRNVestingProxy::_setImplementation: admin only");
        require(implementation_ != address(0), "BRNVestingProxy::_setImplementation: invalid implementation address");
