...
contract BRNVaultAdminStorage {
    ...
    */
    ...
    /**
    * @notice Active brains of BRN Vault
    */
    address public implementation;

    /**
    * @notice Pending brains of BRN Vault
    */
    address public pendingBRNVaultImplementation;
}

contract BRNVaultStorageV1 is BRNVaultAdminStorage {
    /// @notice Guard variable for re-entrancy checks
    bool internal _notEntered;

    /// @notice The reward token store
    address public brnStore;

    /// @notice The brn token address
...
contract BRNVaultStorage is BRNVaultStorageV1 {
